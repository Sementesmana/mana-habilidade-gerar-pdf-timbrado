...
- Python >=3.10
- Instalação: `pip install "git+https://github.com/Sementesmana/mana-habilidade-placeholder.git@v0.1.0"` (GitHub Packages PyPI foi descontinuado em 2024 — padrão Maná = git+https)
